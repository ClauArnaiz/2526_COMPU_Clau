"""
Script generado a partir del notebook OBLIGATORIO_3(1).ipynb.
Física Computacional: ecuación de Schrödinger dependiente del tiempo.

Ejecutar con:
    python obligatorio_schrodinger.py
"""
